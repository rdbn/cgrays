...
class AdminCasesController extends FOSRestController
{
     ...
     * @param $casesId
     *
     * @Rest\Get("/admin/cases/show-list-skins-pubg/{casesId}", requirements={"casesId": "\d+"}, defaults={"casesId": 0})
     * @Rest\View()
     * @return Response
     */
    public function getShowListSkinsPUBGAction(Request $request, $casesId = 0)
    {
        $form = $this->createForm(CasesFormPUBGFilterType::class);
        $form->handleRequest($request);
