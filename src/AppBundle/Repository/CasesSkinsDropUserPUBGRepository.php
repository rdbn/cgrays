...
/**
 * CasesSkinsDropUserPUBGRepository
 *
 * This class was generated by the PhpStorm "Php Annotations" Plugin. Add your own custom
 * repository methods below.
 */
class CasesSkinsDropUserPUBGRepository extends EntityRepository
{
    /**
    ...
    public function findLastSkinsDrop($domainId)
    {
        ...
        try {
            ...
            SELECT
              ...
              csdu.created_at
            FROM cases_skins_drop_user_pubg csdu
              LEFT JOIN cases c ON csdu.cases_id = c.id
              LEFT JOIN users u ON csdu.user_id = u.id
              LEFT JOIN skins_pubg s ON csdu.skins_id = s.id
    ...
    public function getCountSkinsDrop($domainId)
    {
        ...
        try {
            $stmt = $dbal->prepare("
            SELECT count(csdu.id) as count_drop_skins FROM cases_skins_drop_user_pubg csdu
              LEFT JOIN cases_domain cd ON csdu.cases_domain_id = cd.id
            WHERE cd.uuid = :uuid
            ");
            $stmt->bindParam('uuid', $domainId, \PDO::PARAM_STR);
