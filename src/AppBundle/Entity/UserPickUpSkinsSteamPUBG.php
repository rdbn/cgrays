...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\UserPickUpSkinsSteamPUBGRepository")
 * @ORM\Table(name="user_pick_up_skins_steam_pubg")
 */
class UserPickUpSkinsSteamPUBG
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\SkinsPUBG", inversedBy="userPickUpSkinsUser")
     ...
     *
     * @return UserPickUpSkinsSteamPUBG
     */
